...
fun winnerSeed(serverSeed: String, clientSeed: String): Int {
    val hash = sha256(serverSeed,clientSeed).toList().shuffled().joinToString("")
    val number = hash.substring(0,8).toLong(16) // Gets 8 characters (64 bit) of the hash and turns them into Long with base 16
